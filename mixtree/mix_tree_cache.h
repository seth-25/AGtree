...
public:
    ...
    void crackG(Node *&node, float *query, float query_r, std::vector<float> &ans_dis) override;

    void rangeSearchImp(Node *&node, float *query, float query_r, float pq_dis, std::vector<float> &ans_dis) override;
